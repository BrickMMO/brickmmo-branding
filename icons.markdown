...
<table width="100%">
    <tr>
        <td width="25%">
            <h3>ASSETS</h3>
            <img src="icons/png/assets.png">
            <ul>
                <li><a href="icons/png/assets.png" download>assets.png</a></li>
                <li><a href="icons/svg/assets.svg" download>assets.svg</a></li>
                <li><a href="icons/svg-black/assets-black.svg" download>assets-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>APPLICATIONS</h3>
            <img src="icons/png/applications.png">
            <ul>
                <li><a href="icons/png/applications.png" download>applications.png</a></li>
                <li><a href="icons/svg/applications.svg" download>applications.svg</a></li>
                <li><a href="icons/svg-black/applications-black.svg" download>applications-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>BRANDING</h3>
            <img src="icons/png/branding.png">
            <ul>
                <li><a href="icons/png/branding.png" download>branding.png</a></li>
                <li><a href="icons/svg/branding.svg" download>branding.svg</a></li>
                <li><a href="icons/svg-black/branding-black.svg" download>branding-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
    ...
    <tr>
        ...
        <td width="25%">
            <h3>CRYPTO</h3>
            <img src="icons/png/crypto.png">
            <ul>
                <li><a href="icons/png/crypto.png" download>crypto.png</a></li>
                <li><a href="icons/svg/crypto.svg" download>crypto.svg</a></li>
                <li><a href="icons/svg-black/crypto-black.svg" download>crypto-black.svg</a></li>
            </ul>
        </td>
    </tr>
    <tr>
        <td width="25%">
            <h3>DEMO</h3>
            <img src="icons/png/demo.png">
            <ul>
            <li><a href="icons/png/demo.png" download>demo.png</a></li>
            <li><a href="icons/svg/demo.svg" download>demo.svg</a></li>
            <li><a href="icons/svg-black/demo-black.svg" download>demo-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>DISPLAY</h3>
            <img src="icons/png/display.png">
            <ul>
                <li><a href="icons/png/display.png" download>display.png</a></li>
                <li><a href="icons/svg/display.svg" download>display.svg</a></li>
                <li><a href="icons/svg-black/display-black.svg" download>display-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>EVENTS</h3>
    ...
    <tr>
        ...
        <td width="25%">
            <h3>LDR</h3>
            <img src="icons/png/ldr.png">
            <ul>
            <li><a href="icons/png/ldr.png" download>ldr.png</a></li>
            <li><a href="icons/svg/ldr.svg" download>ldr.svg</a></li>
            <li><a href="icons/svg-black/ldr-black.svg" download>ldr-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>LIST</h3>
    ...
    <tr>
        <td width="25%">
            <h3>MAPS</h3>
            <img src="icons/png/maps.png">
            <ul>
            <li><a href="icons/png/maps.png" download>maps.png</a></li>
            <li><a href="icons/svg/maps.svg" download>maps.svg</a></li>
            <li><a href="icons/svg-black/maps-black.svg" download>maps-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>MEDIA</h3>
    ...
    <tr>
        ...
        <td width="25%">
            ...
            <li><a href="icons/svg-black/placekit-black.svg" download>placekit-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>POWER GRID</h3>
    ...
    <tr>
        ...
        <td width="25%">
            <h3>SCILS</h3>
            <img src="icons/png/scils.png">
            <ul>
            <li><a href="icons/png/scils.png" download>scils.png</a></li>
            <li><a href="icons/svg/scils.svg" download>scils.svg</a></li>
            <li><a href="icons/svg-black/scils-black.svg" download>scils-black.svg</a></li>
            </ul>
        </td>
        <td width="25%">
            <h3>SEARCH</h3>
            <img src="icons/png/search.png">
            <ul>
            <li><a href="icons/png/search.png" download>search.png</a></li>
            <li><a href="icons/svg/search.svg" download>search.svg</a></li>
            <li><a href="icons/svg-black/search-black.svg" download>search-black.svg</a></li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td width="25%">
            <h3>TASKS</h3>
            <img src="icons/png/tasks.png">
            <ul>
            <li><a href="icons/png/tasks.png" download>tasks.png</a></li>
            <li><a href="icons/svg/tasks.svg" download>tasks.svg</a></li>
            <li><a href="icons/svg-black/tasks-black.svg" download>tasks-black.svg</a></li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="25%">
            ...
            <li><a href="icons/svg-black/videokit-black.svg" download>videokit-black.svg</a></li>
            </ul>
        </td>
        <td width="25%"></td>
        <td width="25%"></td>
...
BrickMMO icons can be included as icon files using the [Glyphs](https://glyphs.brickmmo.com) CSS library or as PNGs using the [BrickMMO CDN](https://cdn.brickmmo.com). 
